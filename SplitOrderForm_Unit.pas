...
begin
  ...
  begin
    ...
    {
      Правила переноса
      1.Если товар не может быть дробным и кол-во больше 1 => то форма ввода кол-ва,
        иначе переносим полностью
      2.Если товар может быть дробным и кол-во больше либо равно 1 => то форма ввода кол-ва
      3.Если товар может быть дробным и кол-во меньше => переносим полностью
    }
