object RestMainForm: TRestMainForm
    ...
    object pnlExtra: TPanel
      ...
      object pcExtraButton: TAdvPageControl
        ...
        object tsOrderButton: TAdvTabSheet
          ...
          object btnChangeDocNumber: TAdvSmoothToggleButton
            AlignWithMargins = True
            Left = 3
            Top = 498
            Width = 74
  ...
  object actList: TActionList
    ...
    object actChangeDocNumber: TAction
      Category = 'menu'
      Caption = #1048#1079#1084#1077#1085#1080#1090#1100' '#8470' '#1079#1072#1082#1072#1079#1072
      OnUpdate = actChangeDocNumberUpdate
    end
  end
